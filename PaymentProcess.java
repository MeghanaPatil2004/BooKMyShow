...
public class PaymentProcess extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 30, 585, 89));

        gst_label.setBackground(new java.awt.Color(204, 102, 255));
        gst_label.setFont(new java.awt.Font("Arial Black", 1, 24)); // NOI18N
        gst_label.setForeground(new java.awt.Color(255, 255, 255));
        gst_label.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        gst_label.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, null, new java.awt.Color(204, 204, 255), null, new java.awt.Color(204, 204, 255)));
        gst_label.setOpaque(true);
        jPanel1.add(gst_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 450, 553, 71));

        total_label.setBackground(new java.awt.Color(204, 102, 255));
        total_label.setFont(new java.awt.Font("Arial Black", 1, 24)); // NOI18N
        ...
        total_label.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, null, new java.awt.Color(204, 204, 255), null, new java.awt.Color(153, 153, 255)));
        total_label.setOpaque(true);
        jPanel1.add(total_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 540, 553, 71));
        ...
        jPanel1.add(Back_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(105, 650, 240, 60));

        panel1.setBackground(new java.awt.Color(255, 204, 204,80));
        ...
        jPanel2.setBackground(new java.awt.Color(153, 56, 148));
        jPanel2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        panel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 730, 110));
        ...
        next_btn.setBackground(new java.awt.Color(153, 0, 153));
        ...
        panel1.add(next_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 650, 240, 60));

        jPanel1.add(panel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 770, 760));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 30, 770, 760));
